...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        for btn in self.buttons:
            btn.setFixedSize(150, 130)  # mygtuku dydis
            btn.setStyleSheet("""
                        QPushButton {
                            font-size: 70px;             # simboliu dydis
                            font-weight: bold;
